...
namespace TTLRC {
    public class EncodeHelper {
        public static string ToTTHexString(string s, Encoding encoding) {
        ...
        public static string CreateTTCode(string singer, string title, int lrcId) {
            string qqHexStr = ToTTHexString(singer + title, Encoding.UTF8);
