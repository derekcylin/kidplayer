...
namespace Mp3Tag
{
    ...
    internal class Mp3TagID3V1
    {
        ...
        public Mp3TagID3V1(string mp3FilePath)
        {
            ...
            this.title = Encoding.Default.GetString(tagBody, 3, 30).TrimEnd().TrimEnd('\0');
            this.artist = Encoding.Default.GetString(tagBody, 33, 30).TrimEnd().TrimEnd('\0');
            this.album = Encoding.Default.GetString(tagBody, 62, 30).TrimEnd().TrimEnd('\0');
            this.pubYear = Encoding.Default.GetString(tagBody, 93, 4).TrimEnd().TrimEnd('\0');
